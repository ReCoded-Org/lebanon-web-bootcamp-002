...
shapeSelect.addEventListener("change",(e)=>{
  if(shapeSelect.value == 0 || shapeSelect.value == 1 ){
    dimInput2.style.display  = "none";
  }
  else{
     dimInput2.style.display  = "inline";
  }
})
...
shapeForm.addEventListener("submit", function(e) {
  ...
  const shape = new Shape(shapeSelect.options[shapeSelect.selectedIndex].text ,dimInput1.value,dimInput2.value );
...
class Shape{
  ...
  getDimension1(){ return this.dim1}
  getDimension2(){return this.dim2}


  calculateArea(){
      switch(this.type){
        case "Circle": return Math.PI*this.dim1**2
       break;
        case "Square": return this.dim1 *this.dim1
       break;
        case "Rectangle": return this.dim1*this.dim2
       break;
        case "Triangle": return (this.dim1 * this.dim2)/2
       break;
       default:break;
       }
  ...
  calculateCircumference(){
      switch(this.type){
        case "Circle": return Math.PI*this.dim1*2
       break;
        case "Square": return this.dim1*4
       break;
        case "Rectangle": return (this.dim1+this.dim2)*2
       break;
        case "Triangle": return "it's complicated"
       break;
       default:break;
       }
  }
